...
/**
 * BQPaymentTermsRetrieveOutputModelPaymentTermsInstanceRecordCardCollectionsPaymentTermsContactRecord
 */
public class BQPaymentTermsRetrieveOutputModelPaymentTermsInstanceRecordCardCollectionsPaymentTermsContactRecord   {
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: Correspondence content - repayment negotiation/payment request messages sent to involved parties 
